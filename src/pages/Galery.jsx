...
import { galeryImg } from '../services/mirishkorGalery';
import video1 from '../assets/mirishkor-galery/vid1.mp4'

const Galery = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 10;

  const totalPages = Math.ceil(galeryImg.length / itemsPerPage);
  ...
  const currentImages = galeryImg.slice(
  ...
  return (
    <section className="px-4">
      ...
      <div className='mt-10'>
        <video className='w-full rounded-lg h-[400px]' src={video1} controls></video>
      </div>
